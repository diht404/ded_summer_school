...
-fstack-check -fstack-protector -fstrict-overflow -flto-odr-type-merging \
-fno-omit-frame-pointer -fPIE \-fsanitize=address,alignment,bool,\
...
undefined,unreachable,vla-bound,vptr -pie -Wlarger-than=8192 \
-Wstack-usage=8192 "$filename.$extension" -o "$filename.out"
./"$filename.out"
rm ./"$filename.out"